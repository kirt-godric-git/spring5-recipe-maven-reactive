...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        log.debug("Retrieving UnitOfMeasure objects for Each, Tablespoon, Teaspoon, Dash, Pint & Cup in DB...");
        ...
        //get Categories
        log.debug("Retrieving Categories objects for American & Mexican in DB...");
        ...
        //Yummy Guac
        log.debug("Creating Recipe & Note object for Perfect Guacamole...");
        ...
        */
        ...
        //Yummy Tacos
        log.debug("Creating Recipe & Note object for Spicy Grilled Chicken Taco...");
